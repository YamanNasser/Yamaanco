...
{
    public class GroupNotificationRepository : Repository<GroupNotification>, IGroupNotificationRepository
    {
        public GroupNotificationRepository(IYamaancoDbContext context)
            : base(context)
        {
        }
    }
